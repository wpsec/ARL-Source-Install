...
## 2026-03-25（v4.1.24 ~ v4.1.27）

- `[v4.1.27]` AI 管理交互体验优化：补充 `Temperature` 参数说明并将 `输出语言` 选项规范为 `中文/英文` 下拉；`OpenAI 兼容接口管理` 与 `提示词管理` 改为“顶部按钮 + 弹窗表单”新增流程；`系统提示词` 调整为“高级可选”并支持默认折叠展开，减少主流程配置干扰
