...
class Query(DNSQueryBase):
    ...
    def sub_domains(self, target):
        ...
        while True:
            self.logger.debug(
                "hunter_how target:{} page_size:{} curr_page:{}".format(target, self.page_size, curr_page)
            )
            ...
            self.logger.debug(
                "hunter_how target:{} page_size:{} curr_page:{} curr_size:{} more:{}".format(
                    target, self.page_size, curr_page, len(items), has_more
                )
            )
