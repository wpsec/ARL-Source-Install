      ...
      var i = a("5530"),
          ...
          a("1276"),
          {
            ...
            methods: {
              ...
              changeTaskName: function (t) {
                ((this.taskType = this.placeHolderTip[t]),
                  (this.nameString && !this.nameString.includes(this.name)) ||
                    (this.nameString = ""
                      .concat(t.split(",")[1], "-")
                      .concat(this.name)));
              },
        ...
        c = {
                              ...
                              directives: [
                                {
                                  ...
                                  expression:
                                    "['target', { rules: [{ required: true, message: taskType + '!' }] }]",
                                },
                              ],
                              staticStyle: { height: "100px" },
                              attrs: { placeholder: t.taskType },
                            }),
                          ],
                          1,
                        ),
          ...
          methods: {
            ...
            initData: function () {
              var t = this;
              Object(n.e)(Object(i.a)({}, this.params)).then(function (e) {
                200 === e.code &&
                  (e.items.map(function (e, a) {
                    ((e.index = (t.params.page - 1) * t.params.size + a + 1),
                      (e.key = a + 1),
                      (e.desc = e.desc || "-"),
                      (e.hostConfig = t.getHostConfig(e.policy)),
                      (e.siteConfig = t.getSiteConfig(e.policy)),
                      (e.pocConfig = t.getOtherConfig(e.policy.poc_config)),
                      (e.bruteConfig = t.getOtherConfig(
                        e.policy.brute_config,
                      )));
                  }),
                  (t.total = e.total),
                  (t.dataList = e.items));
            ...
            getHostConfig: function (t) {
              ...
              var e = {
                  domain_brute_type: s.a[t.domain_config.domain_brute_type],
                  scanType: s.d[t.ip_config.port_scan_type],
                  settingArray: [],
                },
                a = t.domain_config;
              for (var i in a) !0 === a[i] && e.settingArray.push(s.c[i]);
              var n = t.ip_config;
              for (var r in n) !0 === n[r] && e.settingArray.push(s.c[r]);
              return (
                !0 === t.npoc_service_detection &&
                  e.settingArray.push(s.c.npoc_service_detection),
                "自定义" === e.scanType &&
                  (e.port_custom = t.ip_config.port_custom),
                t.site_config.web_info_hunter &&
                  e.settingArray.push(s.c.web_info_hunter),
                e
              );
            },
            getSiteConfig: function (t) {
              var e = !1,
                a = [];
              for (var i in t.site_config)
                !0 === t.site_config[i] && ((e = !0), a.push(s.g[i]));
              return (
                !0 === t.file_leak && a.push(s.g.file_leak),
                e ? a : null
              );
            },
            ...
            deleteCallback: function (t) {
              var e = this;
              Object(n.b)({ policy_id: [t._id] }).then(function (t) {
                200 === t.code &&
                  ...
                  return a(
                    ...
                    [
                      a(
                        ...
                        t._l(t.searchList, function (e, i) {
                          return a(
                            "span",
                                        ...
                                        [
                                          ...
                                          a(
                                            ...
                                            [
                                              ...
                                              t._v(t._s(e.hostConfig.scanType)),
                                            ],
                                          ),
                                          e.hostConfig.port_custom
                                            ? a(
                                                "div",
                                                {
                                                  staticClass:
                                          ...
                                          a(
                                            ...
                                            [
                                              ...
                                              t._v(
                                                t._s(
                                                  e.hostConfig.settingArray.join(
                                                    "、",
                                                  ),
                                                ),
                                              ),
          ...
          function () {
            ...
            return e(
              ...
              [
                ...
                e("Dtable", {
                  ref: "table",
                  on: { editCallback: this.editCallback },
                }),
              ],
              1,
            );
