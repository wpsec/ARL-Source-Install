    ...
    "9ed6": function (e, t, r) {
      ...
      var a = r("7ded"),
        s = {
          name: "login",
          data: function () {
            return { showParticles: !1, form: this.$form.createForm(this) };
          },
          mounted: function () {
          ...
          methods: {
            ...
            clearPJSDom: function () {
              pJSDom &&
                pJSDom.length > 0 &&
                (pJSDom[0].pJS.fn.vendors.destroypJS(), (pJSDom = []));
            },
          },
          watch: {
            $route: function () {
          ...
          function () {
            ...
            return r(
              ...
              [
                e.showParticles
                  ? r("vue-particles", {
                      attrs: { color: "#e91e63", linesColor: "#e91e63" },
                    })
                  : e._e(),
                r(
                  "div",
                    ...
                    r(
                      ...
                      [
                        ...
                        r(
                          ...
                          [e._v("Internet Asset Automated Collection System")],
                        ),
                      ],
                    ),
                    r(
