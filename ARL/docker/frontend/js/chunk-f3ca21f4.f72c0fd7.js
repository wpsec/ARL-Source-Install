  ...
  ["chunk-f3ca21f4"],
  {
      ...
      var i = n("5530"),
                ...
                return regeneratorRuntime.wrap(function (e) {
                  for (;;)
                    switch ((e.prev = e.next)) {
                      case 0:
                        return (
                          Object(s.D)({ size: 100 }).then(function (e) {
                            t.policyList = e.items;
                          }),
                          (e.next = 3),
                          t.initWeakPolicyList()
                        );
                      case 3:
                        return ((e.next = 5), t.initpocSettingList());
                      case 5:
                        ((t.searchData.hostSettingList = t.hostSettingList),
                          (t.searchData.siteSettingList = t.siteSettingList),
                          t.$route.query._id &&
                            t.getEditdata(t.$route.query._id));
                      case 8:
                      case "end":
                        return e.stop();
                    }
          ...
          methods: {
            ...
            resetForm: function () {
              ...
              ((this.initValue = {
                ...
                (this.showPort_custom =
                  "custom" === this.editItem.policy.ip_config.port_scan_type),
                (this.showHost_timeout =
                  "custom" ===
                  this.editItem.policy.ip_config.host_timeout_type),
                this.initValue.weakSettingGroup.length &&
                  (this.expandKey.push("weakPanel"),
                  this.initValue.weakSettingGroup.length &&
                    this.initValue.weakSettingGroup.length ===
                      this.weakSettingList.length &&
                    (this.checkWeakAll = !0)),
                this.initValue.pocSettingGroup.length &&
                  (this.expandKey.push("pocPanel"),
                  this.pocSettingList.length &&
                    this.initValue.pocSettingGroup.length ===
                      this.pocSettingList.length &&
                    (this.checkPocAll = !0)),
                this.initValue.siteSettingGroup.length &&
                  (this.expandKey.push("sitePanel"),
                  this.initValue.siteSettingGroup.length ===
                    this.siteSettingList.length && (this.checkSiteAll = !0)),
                this.initValue.hostSettingGroup.length ===
                  this.hostSettingList.length && (this.checkHostAll = !0));
            },
            ...
            getParamsType: function (t) {
              var e = [];
              if (["brute_config", "poc_config"].includes(t))
                this.editItem.policy[t].map(function (t) {
                  t.enable && e.push(t.plugin_name);
                });
              else if ("domain" === t) {
                var n = this.editItem.policy.domain_config,
                  i = this.editItem.policy.ip_config;
                for (var r in n) !0 === n[r] && e.push(r);
                for (var a in i) !0 === i[a] && e.push(a);
                this.editItem.policy.npoc_service_detection &&
                  e.push("npoc_service_detection");
              } else if ("site" === t) {
                var o = this.editItem.policy.site_config;
                for (var s in (this.editItem.policy.file_leak &&
                  e.push("file_leak"),
                o))
                  !0 === o[s] && e.push(s);
              }
                            ...
                            case 0:
                              200 === i.code &&
                                (i.items.map(function (t) {
                                  ((t.value = t.plugin_name),
                                    (t.name = t.vul_name));
                                }),
                                (t.weakSettingList = i.items),
                                (t.searchData.weakSettingList =
                                  t.weakSettingList),
                                e(!0));
                            case 1:
                            case "end":
              ...
              return new Promise(function (e) {
                Object(o.d)().then(function (n) {
                  200 === n.code &&
                    ...
                    (t.pocSettingList = n.items),
                    (t.searchData.pocSettingList = t.pocSettingList),
                    e(!0));
                });
              });
            },
            checkAll: function (t, e, n) {
              ...
              var r = {};
              (this.form.getFieldsValue()[e].length === this[t].length
                ? ((r[e] = []), (this[n] = !1))
                : ((r[e] = i), (this[n] = !0)),
            ...
            filterList: function (t, e) {
              ...
              i.timer ||
                (i.timer = setTimeout(function () {
                  if (
                    (clearTimeout(i.timer), (i.timer = null), n.searchObj[t])
                  ) {
                    var r = i[e].filter(function (e) {
                      return e.name
                        .toLowerCase()
                        .includes(n.searchObj[t].toLowerCase());
                    });
                    i.searchData[e] = r;
                ...
                if (!e && !t.submitFLag) {
                  ...
                  t.form.validateFields(function (e, n) {
                    if (!e) {
                      ...
                      if (
                        (Object.assign(s.policy, c, u, l, p, {
                          scope_config: {},
                        }),
                        (s.policy.domain_config.domain_brute_type =
                          n.domain_brute_type),
                        (s.policy.ip_config.port_scan_type = n.port_scan_type),
                        (s.policy.ip_config.port_custom = n.port_custom || ""),
                        (s.policy.ip_config.host_timeout_type =
                          n.host_timeout_type),
                        (s.policy.ip_config.host_timeout = Number(
                          n.host_timeout || "",
                        )),
                        (s.policy.ip_config.port_parallelism = Number(
                          n.port_parallelism,
                        )),
                        (s.policy.ip_config.port_min_rate = Number(
                          n.port_min_rate,
                        )),
                        (s.policy.scope_config.scope_id = n.scope_id),
                        t.submitFLag)
                      )
                        return;
                      if (((t.submitFLag = !0), t.editItem)) {
                        var h = {};
                        ((h.policy_id = t.editItem._id),
                          (h.policy_data = s),
                          Object(o.c)(Object(i.a)({}, h))
                            .then(function (e) {
                              200 === e.code &&
                                (t.$message.success("修改成功"), t.backPage());
                            })
                            .finally(function () {
                              t.submitFLag = !1;
                            }));
                      } else
                        Object(o.a)(Object(i.a)({}, s))
                          .then(function (e) {
                            200 === e.code &&
                              (t.$message.success("添加成功"), t.backPage());
                          })
                          .finally(function () {
                            t.submitFLag = !1;
                          });
              ...
              if ("domain_config" === n) {
                ...
                t &&
                  this[e].map(function (e) {
                    r.includes(e.value)
                      ? (i.domain_config[e.value] = t.includes(e.value))
                      : "npoc_service_detection" === e.value
                        ? (i.npoc_service_detection = t.includes(e.value))
                        : (i.ip_config[e.value] = t.includes(e.value));
                  });
              } else
                "site_config" === n
                  ? ((i.site_config = {}),
                    t &&
                      this[e].map(function (e) {
                        "file_leak" === e.value
                          ? (i.file_leak = t.includes(e.value))
                          : (i.site_config[e.value] = t.includes(e.value));
                      }))
                  : ((i[n] = []),
                    t &&
                      this[e].map(function (e) {
        ...
        l = Object(u.a)(
          ...
          function () {
            ...
            return n(
              "div",
              { staticClass: "policy-setting_wrap" },
              [
                n(
                  "a-form",
                  {
                  ...
                  [
                          ...
                          directives: [
                            {
                              ...
                              value: [
                                "desc",
                                { initialValue: t.initValue.desc },
                              ],
                              expression:
                                "['desc', { initialValue: initValue.desc }]",
                            },
                          ],
                    ...
                    n(
                      "a-collapse",
                      { attrs: { activeKey: t.expandKey, bordered: !1 } },
                      [
                        n(
                          "a-collapse-panel",
                          {
                          ...
                          [
                              ...
                              [
                                n(
                                  "a-select",
                                  {
                                    ...
                                    on: { change: t.port_scan_typeChange },
                                  },
                                  [
                                    n(
                                      "a-select-option",
                            ...
                            n(
                              ...
                              {
                                staticClass:
                                  "checkgroup-wrap checkgroup-wrap_option",
                                attrs: { label: "" },
                              },
                              [
                                n(
                        ...
                        n(
                          "a-collapse-panel",
                          { key: "cipPanel", attrs: { header: "IP高级配置" } },
                          [
                            n(
                              "a-form-item",
                              { attrs: { label: "主机超时时间" } },
                                      ...
                                      value: [
                                        "port_parallelism",
                                        {
                                          rules: [
                                            {
                                              required: !0,
                                              validator: t.numberValid,
                                            },
                                          ],
                                          initialValue:
                                            t.initValue.port_parallelism,
                                        },
                                      ],
                                      expression:
                        ...
                        n(
                          "a-collapse-panel",
                          { key: "pocPanel", attrs: { header: "PоC配置" } },
                          [
                            n(
                              "a-form-item",
                              {
                              ...
                              [
                                n(
                                  ...
                                  [
                                    n(
                                      "div",
                                      { staticClass: "checkbox-list line-two" },
                                      t._l(
                                        t.searchData.pocSettingList,
                                        function (e, i) {
                                          return n(
                                            "a-checkbox",
                                            {
                              ...
                              [
                                n(
                                    ...
                                    directives: [
                                      {
                                        ...
                                        value: [
                                          "scope_id",
                                          {
                                            initialValue: t.initValue.scope_id,
                                          },
                                        ],
                                        expression:
                                  ...
                                  t._l(t.policyList, function (e, i) {
                                    return n(
                                      "a-select-option",
                                      { key: i, attrs: { value: e._id } },
                                      [
                                        t._v(t._s(e.name) + " "),
                                        n("i", { staticClass: "space" }),
                                        t._v(" (" + t._s(e.scope) + ")"),
                                      ],
                                    );
                                  }),
                ...
                n(
                  ...
                  [
                    ...
                    n("a-button", { on: { click: t.backPage } }, [
                      t._v("取 消"),
                    ]),
                  ],
                  1,
    ...
    8631: function (t, e, n) {
      ...
      var i = n("f64c"),
        ...
        a = n.n(r),
        o = n("a18c"),
        s = a.a.create({ baseURL: "/api", timeout: 12e3 });
    ...
    "90d8": function (t, e, n) {
      ...
      var i = n("e20a"),
        ...
        A = function (t) {
          return i.a.post("/scheduler/add/wih_monitor/", t);
        },
        q = function (t) {
          return i.a.get("/asset_wih/", { params: t });
        };
    },
    "96cf": function (t, e, n) {
      var i = (function (t) {
        ...
        return (
          ...
          (d.constructor = h),
          (h.displayName = s(d, o, "GeneratorFunction")),
          ...
          (t.mark = function (t) {
            return (
              Object.setPrototypeOf
                ...
                : ((t.__proto__ = d), s(t, o, "GeneratorFunction")),
          ...
          (S.prototype = {
            ...
            delegateYield: function (t, e, n) {
              return (
                (this.delegate = { iterator: V(t), resultName: e, nextLoc: n }),
    ...
    d294: function (t, e, n) {
      ...
      var i = [
          ...
          { value: "npoc_service_detection", name: "服务(python)识别" },
        ],
        r = [
