...
export const modules: ModuleConfig[] = [
  ...
  },
  {
    id: 'waf_host',
    label: 'WAF识别',
    description: '任务中的 WAF 识别与智能跳过主机',
    group: '风险与规则',
    icon: ShieldAlert,
    listPath: '/waf_host/',
    rowIdKey: '_id',
    ...
    quickFilterKey: 'domain',
    columns: [
      'ip', 'domain', 'port', 'waf_name', 'waf_confidence', 'detection_sources',
      'edge_kind', 'skipped', 'wafw00f_status', 'hit_rule',
    ],
    columnLabels: {
      ip: 'IP',
      domain: '域名',
      ...
      waf_name: 'WAF厂家',
      waf_confidence: '置信度',
      detection_sources: '识别来源',
      edge_kind: '边界类型',
      skipped: '是否跳过',
      wafw00f_status: 'wafw00f状态',
      hit_rule: '命中规则',
    },
    searchFields: [
      { key: 'ip', label: 'IP', placeholder: '请输入IP进行搜索' },
      ...
      { key: 'detection_source', label: '识别来源', placeholder: '请输入识别来源进行搜索' },
      { key: 'wafw00f_status', label: 'wafw00f状态', placeholder: '请输入补充识别状态进行搜索' },
