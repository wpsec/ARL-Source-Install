...
export const UNIFIED_SELECT_CLASS =
  'select select-bordered w-full text-sm text-base-content appearance-none pr-9';

export const CONSOLE_INPUT_CLASS =
  'input input-bordered w-full h-10 text-sm text-base-content';
...
export const CONSOLE_TEXTAREA_MONO_CLASS =
  'textarea textarea-bordered w-full text-sm text-base-content font-mono resize-y';
